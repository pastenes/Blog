...
<div class="cars">
    <ul>
        <li class="wagon">Subaru Outback</li>
        <li class="wagon" id="richards-subaru">Subaru Outback</li>
        <li class="electric">Tesla Model S</li>
    </ul>
</div>
```
...
if (a > 0) {
    ...
    return "Nope, your number is NOT positive";
  }

// A ternary operator is way shorter and easy to write
a > 0 ? "Your number is positive" : "Nope, your number is NOT positive");
```
...
```javascript
// A simple example of what an object looks like:
var car = new Object();
car.make = 'Subaru';
car.model = 'Outback';
car.year = '2015';

// If we console logit we get the objet key/value pairs:
console.log(car)
...
<div className="Image__Small">
    <img
        src="./images/static-site-generator.png"
        title="Gatsby as a static site generator"
        alt="How Gatsby works to generate static sites"
    />
</div>
